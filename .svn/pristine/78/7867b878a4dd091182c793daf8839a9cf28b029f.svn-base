...
public class MyBedFragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener{
    ...
    private void initView() {
        ...
        mBtnOk = (AppCompatButton) mRootView.findViewById(R.id.btn_bed_ok);
        mBtnAll = (AppCompatButton) mRootView.findViewById(R.id.btn_bed_all);
        mBtnCancel = (AppCompatButton) mRootView.findViewById(R.id.btn_bed_cancel);
