...
public class FollowFragment extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener{
    ...
    private AppCompatButton mBtnOk; // 确定按钮
    private AppCompatButton mBtnAll; // 全选按钮
    private AppCompatButton mBtnCancel; // 全不选按钮
    ...
    private void initView() {
        ...
        mBtnOk = (AppCompatButton) mRootView.findViewById(R.id.btn_follow_ok);
        mBtnAll = (AppCompatButton) mRootView.findViewById(R.id.btn_follow_all);
        mBtnCancel = (AppCompatButton) mRootView.findViewById(R.id.btn_follow_cancel);
