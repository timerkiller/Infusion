...
public class SocketEntity implements Parcelable {
    ...
    /* 由app下发命令 */
    public int IsUrgentShutdown; //紧急制动
    public int IsEnableMac; //是否开启声音
    ...
    protected SocketEntity(Parcel in) {
        ...
        IsUrgentShutdown = in.readInt();
        IsEnableMac = in.readInt();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(IsUrgentShutdown);
        dest.writeInt(IsEnableMac);
    }
    ...
    public String toString() {
        return "{" +
                ...
                ", \"IsUrgentShutdown\":" + IsUrgentShutdown +
                ", \"IsEnableMac\":" + IsEnableMac +
                '}';
    }
