...
public class MainActivity extends BaseActivity implements SocketService.IReceiveMessage, IFrag2Act {
    ...
    private static Dialog mProgressDialog = null; //转圈对话框
    ...
    private static SocketService.SocketBinder mSocketBinder;
    ...
    class MessageBackReciver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(SocketService.HEART_BEAT_ACTION)) {
                ...
                mProgressDialog.dismiss();
                mRetryDialog.show();
            } else if(action.equals(SocketService.NEED_SET_IP_ACTION)){
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    {
                        SetActivity.start(MainActivity.this);
                        dialog.dismiss();
                    }
                }).show();
...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIntentFilter.addAction(SocketService.NEED_SET_IP_ACTION);
