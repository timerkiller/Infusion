...
//    private Button mBtnModeCancel; // 模式选择取消按钮
    ...
    public static void start(Activity activty) {
        Intent starter = new Intent(activty, SetActivity.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_server_ok:
                ...
                String strPort = String.valueOf(SocketService.PORT);//mEditPort.getText().toString();
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()){
            case R.id.switch_fast_set:
                if (mTxtvDialogTitle.getText().equals(SetActivity.this.getString(R.string.string_set_sound))){
