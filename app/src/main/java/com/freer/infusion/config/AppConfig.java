...
public class AppConfig {
    ...
    private HashMap<String, String> myBedMap = null; // 我的床位
    private HashMap<String, String> followBedMap = null; // 我关注的床位
    ...
    public HashMap<String, String> getFollowBed() {
        if (SPUtils.contains(SP_FOLLOW_BED)) {
            String str = (String) SPUtils.get(SP_FOLLOW_BED, CommonUtil.hashToString(followBedMap));
            followBedMap = CommonUtil.strToHash(str);
            return followBedMap;
        }
        return followBedMap;
    }
